...
import org.airtribe.assignment.taskmaster.auth.entity.VerificationToken;
...
import org.airtribe.assignment.taskmaster.auth.repository.VerificationTokenRepository;
...
public class UserServiceImpl implements UserService {
    ...
    public User registerUser(UserModel userModel, HttpServletRequest request) throws TokenExpiredException {
        try {
            User user = User.builder()
                    ...
                    .email(userModel.getEmail()).role(userModel.getRole()).firstName(userModel.getFirstName())
            ...
            if (user != null) {
                ...
                System.out.println("Verification token created for user: " + user.getEmail());
    ...
    public UserProfile getUserProfile(String email) {
        ...
        if (user.isPresent()) {
            ...
            userProfile.setRole(user.get().getRole());
            return userProfile;
        } else {
